...
describe('isAnnouncementOnly', () => {
  it('is true for hype trains, solo or full', () => {
...
describe('billboardHoldMs', () => {
  it('gives hype its announcement beat', () => {
    expect(billboardHoldMs(hype(1))).toBe(BILLBOARD_HYPE_HOLD_MS)
    expect(billboardHoldMs(burnHype(1))).toBe(BILLBOARD_HYPE_HOLD_MS)
  })

  it('gives an operator announcement the same beat', () => {
    expect(billboardHoldMs(announce(1))).toBe(BILLBOARD_HYPE_HOLD_MS)
  })

  it('gives a club event the same beat', () => {
    expect(billboardHoldMs(club(1))).toBe(BILLBOARD_HYPE_HOLD_MS)
    expect(billboardHoldMs(burnClub(1))).toBe(BILLBOARD_HYPE_HOLD_MS)
  })
})

describe('billboardShowForMs', () => {
  it('gives a train one hold per item', () => {
  ...
  it('operator announcements ride the same math', () => {
  ...
  it('club events ride the same math', () => {
...
describe('billboardChrome', () => {
  it('labels hype as an announcement', () => {
  ...
  it('labels an operator announcement as an announcement', () => {
  ...
  it('labels a club event as an announcement', () => {
...
describe('billboardShouldCloseAfterHold', () => {
  ...
  it('never closes an empty train — there is nothing to retract', () => {
    expect(billboardShouldCloseAfterHold([], -1)).toBe(false)
  })
})
