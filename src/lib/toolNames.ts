...
const TOOL_NAME_MAP: Record<string, string> = {
  // Chat assistants
  'claude.ai': 'Claude',
  'console.anthropic.com': 'Claude Playground',
  'platform.claude.com': 'Claude Playground',
  'chatgpt.com': 'ChatGPT',
  ...
  'notebooklm.google': 'Gemini Notebook',
  'notebook.google.com': 'Gemini Notebook',
  'notebook.google': 'Gemini Notebook',
  ...
  'app.lumalabs.ai': 'Luma Dream Machine',
  'kling.ai': 'Kling AI',
