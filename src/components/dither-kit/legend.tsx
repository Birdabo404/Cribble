      ...
      {chart.names.map((name) => {
        ...
        return (
          <button
            ...
            className={cn(
              // [Cribble patch] text-muted-foreground doesn't generate here;
              // zinc flips per theme.
              "flex items-center gap-1.5 font-mono text-[11px] text-zinc-500 transition-opacity",
              isClickable &&
