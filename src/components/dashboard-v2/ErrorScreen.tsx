export function ErrorScreen({ message }: { message: string | null }) {
  return (
    <div className="dossier-canvas min-h-screen bg-black text-zinc-100 font-mono flex items-center justify-center px-4">
      <div className="border border-zinc-800 bg-zinc-950 rounded-xl p-8 text-center max-w-sm">
        ...
        <a
          href="/login"
          className="inline-block text-xs tracking-[0.3em] px-4 py-2 border border-zinc-700 rounded hover:border-zinc-500 transition-colors"
        >
          SIGN IN
        </a>
      </div>
