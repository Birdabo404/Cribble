...
// Legacy dashboard (v2 design) — preserved for rollback.
// To roll back: copy this file's contents over src/app/dashboard/page.tsx.
...
export default function DashboardV2Legacy() {
