...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6 rounded-md border border-accent/25 bg-zinc-950/80 p-8 font-mono shadow-[0_0_44px_rgb(var(--accent-rgb)/0.08)]">
        ...
        <p className="text-center text-xs text-gray-500">
          ...
          <a
            href="/"
            className="text-accent/80 underline-offset-2 transition-colors hover:text-accent"
          >
            join the waitlist
          </a>
          .
